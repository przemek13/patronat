...
public class ConferenceRoomController {
    ...
    @GetMapping("/rooms")
    public Resources<Resource<ConferenceRoom>> getConferenceRoom() {
    ...
    ResponseEntity addConferenceRoom(@RequestBody ConferenceRoom newConferenceRoom, @PathVariable Long id) throws SameNameException, NoSuchIdException {
    ...
    ResponseEntity deleteConferenceRoom(@PathVariable Long id) throws NoSuchIdException {
        service.delete(id);
        return ResponseEntity.ok().build();
    }
}
